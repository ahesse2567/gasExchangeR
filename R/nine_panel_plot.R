...
nine_panel_plot <- function(.data,
  ...
  ve_vs_vco2_plot <- make_ve_vs_vco2_plot(
    .data = .data,
    vt1_dat = vt1_dat,
    vt2_dat = vt2_dat,
    vco2 = vco2,
  ...
  v_slope_hr_plot <- make_v_slope_hr_plot(
    .data = .data,
    vt1_dat = vt1_dat,
    vt2_dat = vt2_dat,
    vo2 = vo2,
  ...
  vent_eqs_plot <- make_vent_eqs_vs_time_plot(
    .data = .data,
    vt1_dat,
    vt2_dat,
    vo2 = vo2,
  ...
  vt_vs_ve_plot <- make_vt_vs_ve_plot(
    .data = .data,
    vt1_dat,
    vt2_dat,
    ve = ve,
  ...
  rer_vs_time_plot <- make_rer_vs_time_plot(
    .data = .data,
    vt1_dat,
    vt2_dat,
    time = time,
  ...
  end_tidals_vs_time_plot <- make_end_tidals_vs_time_plot(
    .data = .data,
    vt1_dat,
    vt2_dat,
    time = time,
...
make_hr_o2pulse_vs_time_plot <- function(.data,
  ...
  out_plot <- ggplot2::ggplot(
    ...
    ggplot2::geom_point(
      ggplot2::aes(
        y = (.data[[vo2]] / .data[[hr]]) * scale_factor,
    ...
    ggplot2::scale_color_manual(
      name = NULL, values = c("darkred", "black"),
...
make_vent_eqs_vs_time_plot <- function(.data,
  ...
  .data <- .data %>%
    dplyr::mutate(
      ve_vo2 = !!rlang::sym(ve) / !!rlang::sym(vo2) * 1000,
